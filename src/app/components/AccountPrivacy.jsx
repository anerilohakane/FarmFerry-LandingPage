            ...
            {section.content.map((item, index) => (
              <div key={index} className="border border-gray-200 rounded-xl overflow-hidden transition-all hover:shadow-md">
                ...
                >
                  ...
                  <svg
                    className={`w-5 h-5 text-green-700 transform transition-transform ${expandedItems[`information-${index}`] ? 'rotate-180' : ''}`}
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
            ...
            {section.content.map((item, index) => (
              <div key={index} className="border border-gray-200 rounded-xl overflow-hidden transition-all hover:shadow-md">
                ...
                >
                  <span className="font-medium text-gray-800">{item.title}</span>
                  <svg
                    className={`w-5 h-5 text-green-700 transform transition-transform ${expandedItems[`sharing-${index}`] ? 'rotate-180' : ''}`}
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="space-y-4">
            ...
            <div className="mt-6 p-6 bg-green-50 rounded-xl border border-green-200">
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-medium text-gray-800 mb-2">Contact Our Privacy Team</h4>
                  <p className="text-gray-600 text-sm mb-2">For any privacy-related questions or concerns, email us at:</p>
                  <a href="mailto:privacy@farmferry.com" className="text-green-600 font-medium text-sm hover:text-green-800 transition-colors">
    ...
    <div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6 mb-6">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between">
          <div>
            <h1 className="text-2xl font-bold text-green-800 mb-2">Account Privacy & Policy</h1>
          ...
          <div className="mt-4 md:mt-0">
            <div className="flex items-center bg-green-100 px-4 py-2 rounded-lg">
              ...
              <span className="text-green-700 font-medium text-sm">Your data is protected</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col lg:flex-row gap-6">
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <IconComponent size={20} className={activeSection === key ? "text-green-600" : "text-gray-500"} />
                      <span className="text-sm">{privacyData[key].title}</span>
                    </div>
                    <ArrowRight size={18} className={activeSection === key ? "text-green-600" : "text-gray-400"} />
                  </button>
                );
              })}
            </div>
        ...
        {/* Content */}
        <div className="lg:w-3/4 bg-white rounded-xl border border-gray-200 p-6">
          {renderContent()}
        </div>
      </div>
      ...
      <div className="mt-6 p-6 bg-green-50 rounded-xl border border-green-200">
        <div className="flex items-start">
          <Shield size={20} className="text-green-600 mr-4 mt-0.5" />
          <div>
            <h3 className="font-medium text-gray-800 mb-2">FarmFerry Privacy Commitment</h3>
