...
import { Plus, MapPin, Home, Briefcase, MoreHorizontal, Edit3, Trash2, Star, CheckCircle, Loader } from 'lucide-react';
...
const AddressList = ({ showManagementOptions = true, selectedAddress = null, onSelectAddress = null, showAddNewButton = true }) => {
  ...
  // Address type icons - updated to match Header component style
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Loading state - matches Header component style */}
      {loading ? (
        ...
        // Empty state - matches Header component style
          ...
          {addresses.map((address) => (
            ...
            >
              <div className="flex items-start justify-between">
                ...
                {/* Management options - only show if enabled */}
                {showManagementOptions && (
      ...
      {/* Add new address button - matches Header component style */}
      {/* {showManagementOptions && showAddNewButton && !loading && addresses.length > 0 && (
        <button
          onClick={() => setShowAddAddressForm(true)}
          className="w-full border-2 border-dashed border-gray-300 rounded-xl p-5 hover:border-green-500 hover:bg-green-50 transition-colors flex items-center justify-center gap-2 text-green-600 font-medium"
        >
